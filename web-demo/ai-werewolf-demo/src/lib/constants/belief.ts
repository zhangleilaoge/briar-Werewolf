...
export const BELIEF_VERY_LOW_SUSPICION_THRESHOLD = 0.3; // 极低嫌疑阈值（低于此值认为基本无嫌疑）
...
export const BELIEF_SUSPICION_BASE = 0;                   // 基础嫌疑值（默认0，无信息时不预设怀疑）
...
export const BELIEF_IDENTITY_CRISIS_KNOWN = 0.7;              // 已知身份危机
export const BELIEF_IDENTITY_CRISIS_UNKNOWN = 0.1;            // 未知身份危机
