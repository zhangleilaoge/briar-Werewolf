...
export const SCORE_DEFAULT_SUSPECT = 60;              // 村民怀疑普通嫌疑人的分数
export const SCORE_DEFAULT_DEFEND = 50;               // 村民袒护被怀疑好人的分数
export const SCORE_DEFAULT_ACCUSE = 80;               // 村民强烈指认的分数
export const SCORE_DEFAULT_CALL_VOTE = 70;            // 村民号召投票的分数
export const SCORE_DEFAULT_BLOCK_VOTE = 40;           // 村民阻止投票的分数
export const SCORE_DEFAULT_GUARANTEE = 60;            // 村民担保清白的分数
...
export const SCORE_WW_TEAMMATE_CRISIS_GOUGE = 90;   // 狼队友身份危机时，落井下石（撇清关系）的分数
export const SCORE_WW_TEAMMATE_CRISIS_DEFEND = 60;  // 狼队友身份危机时，冒险辩护的分数
